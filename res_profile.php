...
// $resident = your query result

$photoPath = !empty($resident['photo']) ? "../" . $resident['photo'] : "../uploads/default.png";
...
<div id="completeProfileModal" class="modal">
  <div class="modal-content">
    ...
    <button class="btn blue" onclick="openModal('allSectionsModal')">Complete Now</button>
  </div>
</div>
...
<div class="hero-section">
    <div class="hero-content">
        <div class="profile-photo">
            <img src="uploads/<?php echo htmlspecialchars($resident['photo']); ?>" alt="Profile">
...
<h3>Address / Residency Information <span class="edit-icon" data-modal="addressModal">✎</span></h3>
        <ul class="info-list">
          <li><strong></strong> </strong><?php echo htmlspecialchars($resident['home_number']); ?>, <?php echo htmlspecialchars($resident['street']); ?>, <?php echo htmlspecialchars($resident['barangay']); ?>, <?php echo htmlspecialchars($resident['municipality']); ?>, <?php echo htmlspecialchars($resident['city_province']); ?></li>
            <li><strong>Years of Residency: </strong> <?php echo htmlspecialchars($resident['years_of_residency']); ?></li>
            <li><strong>Resident Type: </strong> <?php echo htmlspecialchars($resident['resident_type']); ?></li>
            <li><strong>Resident since birth: </strong> <?php echo htmlspecialchars($resident['resident_since_birth']); ?></li>
        </ul>
        <hr>
        <br>
        ...
        <ul class="info-list">
          <li><strong><ion-icon name="male-female"></ion-icon>Fullname</strong> <?php echo htmlspecialchars($resident['first_name'] . ' ' . $resident['last_name']); ?></li>
            <li><strong><ion-icon name="male-female"></ion-icon></strong> <?php echo htmlspecialchars($resident['gender']); ?></li>
            <li><strong><ion-icon name="heart-half"></ion-icon></strong> <?php echo htmlspecialchars($resident['civil_status']); ?></li>
            <li><strong><ion-icon name="calendar"></ion-icon></strong> <?php echo htmlspecialchars($resident['date_of_birth']); ?></li>
            <li><strong><ion-icon name="location"></ion-icon></strong> <?php echo htmlspecialchars($resident['place_of_birth']); ?></li>
            <li><strong>Religion:</strong> <?php echo htmlspecialchars($resident['religion']); ?></li>
            <li><strong><ion-icon name="flag"></ion-icon></strong> <?php echo htmlspecialchars($resident['nationality']); ?></li>
        </ul>
        <h3>Educational Status</h3>
        <ul class="info-list">
            <li><strong>Currently Studying?</strong> <?php echo htmlspecialchars($resident['currently_studying']); ?></li>
            <li><strong>Grade/Year Level: </strong> <?php echo htmlspecialchars($resident['grade_year_level']); ?></li>
            <li><strong>Highest Educational Attainment:</strong> <?php echo htmlspecialchars($resident['highest_educ_attainment']); ?></li>
            <li><strong>Name of School:</strong> <?php echo htmlspecialchars($resident['school_name']); ?></li>
        </ul>
        <hr>
        <br>
...
<ul class="info-list">
  <li><strong>Source of Income (Main Category):</strong> <?php echo htmlspecialchars($resident['income_category']); ?></li>

  <!-- EMPLOYED -->
  <?php if($resident['income_category'] == 'Employed'): ?>
    <li><strong>Occupation / Job Title:</strong> <?php echo htmlspecialchars($resident['occupation']); ?></li>
    <li><strong>Work Department:</strong> <?php echo htmlspecialchars($resident['work_department']); ?></li>
    <li><strong>Company / Employer:</strong> <?php echo htmlspecialchars($resident['employer']); ?></li>
    <li><strong>Type of Work:</strong> <?php echo htmlspecialchars($resident['type_of_work']); ?></li>
    <li><strong>Monthly Income Range:</strong> <?php echo htmlspecialchars($resident['monthly_income_range']); ?></li>
  <?php endif; ?>

  <!-- SELF-EMPLOYED -->
  <?php if($resident['income_category'] == 'Self-Employed'): ?>
    <li><strong>Type of Business:</strong> <?php echo htmlspecialchars($resident['business_type']); ?></li>
    <li><strong>Business Name:</strong> <?php echo htmlspecialchars($resident['business_name']); ?></li>
    <li><strong>Income Range:</strong> <?php echo htmlspecialchars($resident['business_income_range']); ?></li>
  <?php endif; ?>

  <!-- STUDENT -->
  <?php if($resident['income_category'] == 'Student'): ?>
    <li><strong>School Name:</strong> <?php echo htmlspecialchars($resident['school_name']); ?></li>
    <li><strong>Grade / Year Level:</strong> <?php echo htmlspecialchars($resident['grade_year_level']); ?></li>
    <li><strong>Supported By:</strong> <?php echo htmlspecialchars($resident['student_supported_by']); ?></li>
  <?php endif; ?>

  <!-- PENSIONER -->
  <?php if($resident['income_category'] == 'Pensioner'): ?>
    <li><strong>Pension Type:</strong> <?php echo htmlspecialchars($resident['pension_type']); ?></li>
    <li><strong>Monthly Pension:</strong> <?php echo htmlspecialchars($resident['monthly_pension']); ?></li>
  <?php endif; ?>

  <!-- OFW -->
  <?php if($resident['income_category'] == 'OFW'): ?>
    <li><strong>Country of Work:</strong> <?php echo htmlspecialchars($resident['ofw_country']); ?></li>
    <li><strong>Job Position Abroad:</strong> <?php echo htmlspecialchars($resident['ofw_job_position']); ?></li>
    <li><strong>Work Agency:</strong> <?php echo htmlspecialchars($resident['ofw_agency']); ?></li>
  <?php endif; ?>
</ul>
...
<hr><br>
        ...
        <ul class="info-list">
          <li><strong>4Ps Beneficiary: </strong> </strong><?php echo htmlspecialchars($resident['beneficiary_4ps']); ?></li>
            <li><strong>Social Pension Beneficiary: </strong> <?php echo htmlspecialchars($resident['social_pension_beneficiary']); ?></li>
            <li><strong>SSS Pensioner: </strong> <?php echo htmlspecialchars($resident['sss_pensioner']); ?></li>
            <li><strong>GSIS Pensioner: </strong> <?php echo htmlspecialchars($resident['gsis_pensioner']); ?></li>
            <li><strong>PhilHealth Member: </strong> <?php echo htmlspecialchars($resident['philhealth_member']); ?></li>
            <li><strong>Other Cash Assistance Recipient: </strong> <?php echo htmlspecialchars($resident['other_cash_assistance']); ?></li>
        </ul>

        <h3>Additional Optional Categories</h3>
        <ul class="info-list">
          <li><strong>4Ps Child Beneficiary: </strong> </strong><?php echo htmlspecialchars($resident['child_4ps_beneficiary']); ?></li>
            <li><strong>Disaster-Vulnerable Person: </strong> <?php echo htmlspecialchars($resident['disaster_vulnerable']); ?></li>
            <li><strong>Evacuation Assistance Needed: </strong> <?php echo htmlspecialchars($resident['evacuation_assistance']); ?></li>
            <li><strong>Livelihood Assistance Beneficiary: </strong> <?php echo htmlspecialchars($resident['livelihood_assistance']); ?></li>
            <li><strong>Registered Farmer: </strong> <?php echo htmlspecialchars($resident['registered_farmer']); ?></li>
            <li><strong>Registered Fisherfolk: </strong> <?php echo htmlspecialchars($resident['registered_fisherfolk']); ?></li>
        </ul>
        <hr>
        <br>
        ...
        <ul class="info-list">
          <li><strong>Registered Voter: </strong><?php echo htmlspecialchars($resident['registered_voter']); ?></li>
            <li><strong>Voter in this Barangay: </strong> <?php echo htmlspecialchars($resident['voter_in_barangay']); ?></li>
            <li><strong>Precint No.:</strong> <?php echo htmlspecialchars($resident['precinct_number']); ?></li>
        </ul>

        <h3>Social Category</h3>
        <ul class="info-list">
          <li><strong>Senior Citizen: </strong><?php echo htmlspecialchars($resident['senior_citizen']); ?></li>
            <li><strong>Person with Disability (PWD): </strong> <?php echo htmlspecialchars($resident['pwd']); ?>| <strong>Type: </strong></strong> <?php echo htmlspecialchars($resident['disability_type']); ?></li>
            <li><strong>Solo Parent:</strong> <?php echo htmlspecialchars($resident['solo_parent']); ?></li>
            <li><strong>Youth Member (15–30 y/o): </strong><?php echo htmlspecialchars($resident['youth_member']); ?></li>
            <li><strong>Indigenous Peoples (IP) Member: </strong><?php echo htmlspecialchars($resident['ip_member']); ?></li>
            <li><strong>OFW Household Member: </strong> <?php echo htmlspecialchars($resident['ofw_household_member']); ?></li>
            <li><strong>Pregnant Woman:</strong> <?php echo htmlspecialchars($resident['pregnant_woman']); ?></li>
            <li><strong>Lactating Mother:</strong> <?php echo htmlspecialchars($resident['lactating_mother']); ?></li>
        </ul>
        <hr>
        <br>
        ...
        <ul class="info-list">
          <li><strong>Fullname: </strong> </strong><?php echo htmlspecialchars($resident['first_name']); ?> <?php echo htmlspecialchars($resident['middle_name']); ?> <?php echo htmlspecialchars($resident['last_name']); ?></li>
            <li><strong>Email: </strong> <?php echo htmlspecialchars($resident['email']); ?></li>
            <li><strong>Contact No.: </strong> <?php echo htmlspecialchars($resident['contact_number']); ?></li>
    ...
    <form action="update_address.php" method="POST">
      ...
      <div class="form-row">
        <div class="form-group">
          ...
          <input type="text" name="barangay" id="barangay" value="<?php echo htmlspecialchars($resident['barangay']); ?>">
        </div>
        <div class="form-group">
...
<div id="employmentModal" class="modal">
  <div class="modal-content modal-form">
    ...
    <form action="update_employment.php" method="POST">
      <br>
...
<div id="govProgramModal" class="modal">
  <div class="modal-content modal-form">
    ...
    <form action="update_government_program.php" method="POST">
...
<div id="otherInfoModal" class="modal">
  <div class="modal-content modal-form">
    ...
    <form action="update_other_information.php" method="POST">
